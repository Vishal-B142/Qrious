...
?>  
    ...
    <body>
        <div id="signup">
            <div class="signuplogo position-fixed text-center" style="float: center; padding-left:75px";>
            <img src="img/qriouslogotransparent.png" height="170" width="550">
            </div>
             ...
             <div class="container">                
                <div class="row">
                    <div class="col-sm-6 offset-sm-1">
                        ...
                        <div class="signup-left position-fixed text-center" style="float: left";>
                            ...
                            <form id="signup-form" action="includes/signup.inc.php" method='post' 
                                ...
                                <div style="float: right; width: -80%";>
                                 <a href="login.php" class="btn btn-dark btn-lg mr-1" style="margin:5px;">Back to Login</a>
                    ...
                    <div class="col-sm-6 offset-sm-6 text-center">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6 align-self-center">
                                <img id="blah" class="rounded" src="#" alt="your image" class="img-responsive rounded"
                                     style="height: 180px; padding-top: 10px; width: 190px; object-fit: cover;">
                                <br><br><label class="btn btn-primary ">
                                    Set An Image <input type="file" id="imgInp" name='dp' hidden>
                              </label>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-group" padding>
                           <div style="float: center; padding-bottom: 50px";>
