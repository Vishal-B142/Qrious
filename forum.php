...
<div class="container">
  <form class="form-inline" method="post" action="search_forum.php"> <!-- action="search.php"-->
    <input type="text" name="s_name" class="form-control" placeholder="Search for forums...">
    ...
    <body style="background: #f1f1f1">
      ...
      <div class="d-flex align-items-center p-3 my-3 text-white-50 bg-purple rounded shadow-sm" style="background: #3c4049">
        ...
        <div class="lh-100">
          ...
          <p style="color: lightgrey">For Inquisitive Minds</p>
        </div>
      </div>
      ...
      <div class="my-3 p-3 bg-white rounded shadow-sm">
        <h5 class="border-bottom border-gray pb-2 mb-0">Forums</h5>
