      ...
      <div class="container main">
        <div class="row">
          ...
          <div class="col-sm-8 text-center" id="user-section">
              <img class="cover-img" src="img/user-cover11.png">
                            ...
                            do
                            {
                                echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-blogs">
                                            ...
                                            <img class="card-img-top" src="img/forum-cover3.png" alt="Card image cap">
                                            <div class="card-block p-2">
                            ...
                            {   
                                echo '<div class="col-sm-4" style="padding-bottom: 30px;">
                                        <div class="card user-blogs">
                                            ...
                                            <img class="card-img-top" src="img/poll-cover.jpg" alt="Card image cap">
                                            <div class="card-block p-2">
