                  ...
                  <div class="inbox_chat">
                      ...
                      <?php
                        ...
                        else
                        {
                            ...
                            {
                        ?>
                      <a href='./message.php?id=<?php echo $row['idUsers']; ?>' class="<?php echo $row['idUsers'] == $_GET['id'] ? 'active' : '' ;?>"><div class="chat_list ">
                            <div class="chat_people">
                              ...
                              <div class="chat_ib">
                                <h5>
                                    ...
                                    <span class="chat_date">Qrious User</span>
                                </h5>
                        ...
                        <?php
                            ...
                            if(isset($_GET['id'])){
                                ...
                                die("<div class='text-center'>
                                        <br><br><br>
                                        <h1 class='text-white'>Click on the user to start chatting</h1>
                                     </div>");
                            }
                        ?>
