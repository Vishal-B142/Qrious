...
?> 
    ...
    <body>
        ...
        <div class="cover">
            <div class="messaging">
              <div class="inbox_msg">
                <div class="inbox_people main">
                  <div class="headind_srch">
                    <div class="recent_heading">
                      <h2>Inbox</h2>
                    </div>
                  </div>
                  <div class="inbox_chat d main">
                      ...
                      <a href='./message.php?id=<?php echo $row['idUsers']; ?>' class="<?php if($row['idUsers'] == $_GET['id']){echo 'active';}?>"><div class="chat_list ">
