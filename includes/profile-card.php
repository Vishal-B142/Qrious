            ...
            <div class='card card-profile text-center main'>
                <img alt='' class='card-img-top card-user-cover' src='img/user-cover12.png'>
                <div class='card-block'>
                    ...
                    <?php echo "Welcome&nbsp"; 
                    echo ucwords($_SESSION['userUid']); ?>
